...
public class Form_Trans_Detail extends javax.swing.JFrame {
    ...
    public void Tabelklik(){
        ...
        String id_barang = (String) tabeldetail.getValueAt(pilih, 2);
        txtidbarang.setText(id_barang);
        String nama_barang = (String) tabeldetail.getValueAt(pilih, 3);
    ...
    public void Simpan(){
        ...
        try{
            Statement state  = koneksinya.GetConnection().createStatement();
            state.executeUpdate("insert into transaksi_detail values ('"+id+"','"+nama+"','"+id_barang+"','"+nama_barang+"','"+harga+"','"+jumlah+"', '"+total+"','"+tgl+"')");
    ...
    private void initComponents() {
        ...
        tabeldetail.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID TRANSAKSI", "NAMA", "ID BARANG", "NAMA BARANG", "HARGA BARANG", "JUMLAH BELI", "TOTAL"
            }
        ));
