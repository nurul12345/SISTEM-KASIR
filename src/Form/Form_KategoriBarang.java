 ...
 */
public class Form_KategoriBarang extends javax.swing.JFrame {

    ResultSet Rs;
    
    /**
     * Creates new form Form_Kategoribarang
     */
    public Form_KategoriBarang() {
        initComponents();
        Datatabel();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_KategoriBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_KategoriBarang().setVisible(true);
            }
        });
    }
